...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      let nuevoArreglo = this.amigos.map(valor => valor.nombre);
      return nuevoArreglo;
    }
    ...
    getHobbies() {
      ...
      // Tu código aca:
      let nuevoArreglo = this.hobbies.map(valor => valor);
      return nuevoArreglo;
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      let promedio = this.amigos.map(valor => valor.edad).reduce((a,c) => (a + c) / (this.amigos.length));
      return promedio;
    }
  };
